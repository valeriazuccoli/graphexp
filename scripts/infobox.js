...
var infobox = (function(){
	...
	var _side_image = {};
	var _font_size = "12px";
	var _date_variables = ['dt_var_flagbl', 'data_blocco', 'scad', 'data_conv',
							'data_min_target', 'data_max_target',
							'data_min_flusso', 'data_max_flusso', 
							'data_min_nontarget', 'data_max_nontarget',
							'data_min_tr_carte_bloccate', 'data_max_tr_carte_bloccate'];
